  ...
  transport
    .sendMail({
      ...
      <div style="background-color: white; padding: 20px; border-radius: 10px; max-width: 500px; margin: 0 auto;">
        ...
        <a href="https://ecoclicko.info/confirm/${confirmationCode}" style="background-color: #009e00; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 20px;">Click Here To Activate.</a>
      </div>
    </div>
    ...
    transport
      .sendMail({
        ...
        <div style="background-color: white; padding: 20px; border-radius: 10px; max-width: 500px; margin: 0 auto;">
          ...
          <a href="https://ecoclicko.info/reset-password/${resetCode}" style="background-color: #4CAF50; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 20px;">Click here to reset your password</a>
        </div>
      </div>
        `,
      })
